"use strict";
(self["webpackChunksongbird"] = self["webpackChunksongbird"] || []).push([["src_js_birds-en_js-src_js_birds_js-src_js_card_js-src_js_createElements_js-src_js_translate_js"],{
...
var Card = /*#__PURE__*/function () {
  ...
  _createClass(Card, [{
    ...
    value: function generateCard() {
      ...
      template += "<img class=\"description__img\" src=".concat(this.image, " alt=\"").concat(this.name, "\">");
      template += "</div>";
      template += "<div class=\"description__content\">";
      template += "<div class=\"description__title line\">".concat(this.name);
      template += "</div>";
      template += "<div class=\"description__subtitle line\">".concat(this.species);
      template += "</div>";
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "createAnswerItem": () => (/* binding */ createAnswerItem),
/* harmony export */   "createDescriptionText": () => (/* binding */ createDescriptionText),
/* harmony export */   "createHiddenBirdImage": () => (/* binding */ createHiddenBirdImage),
/* harmony export */   "createNewMainPlayer": () => (/* binding */ createNewMainPlayer)
/* harmony export */ });
var createAnswerItem = function createAnswerItem(name, number) {
  var item = document.createElement('label');
  item.className = 'answers__item';
  item.setAttribute('data-id', number);
  var template = "".concat(name, "\n                  <input type=\"checkbox\">\n                  <span class=\"checkmark\"></span>");
  item.innerHTML = template;
  return item;
};
var createNewMainPlayer = function createNewMainPlayer() {
  var newMainAudio = document.createElement('audio');
...
var createHiddenBirdImage = function createHiddenBirdImage() {
...
var createDescriptionText = function createDescriptionText() {
...
//# sourceMappingURL=src_js_birds-en_js-src_js_birds_js-src_js_card_js-src_js_createElements_js-src_js_translate_js.js.map